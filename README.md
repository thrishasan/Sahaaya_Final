...
- If the system does not understand a command, it responds with an intelligent fallback message
such as “Sorry, I did not understand” in multiple languages (English, Tamil, Hindi)
...
This will load the full Sahaaya application with all features enabled.
